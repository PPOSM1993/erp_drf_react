...
from .models import Enterprise, Employee, Task, TaskStatus
from apps.accounts.models import User, UserGroups, GroupsPermissions, Groups
...
class GroupsSerializer (serializers.ModelSerializer):
    ...
    def get_permissions(self, obj):
        groups = GroupsPermissions.objects.filter(group_id=obj.id).all()
        permissions = []
